...
# file paths
root = '/opt/sdb/workspace/data/COCO'
train_images_dir = os.path.join(root, 'images/train2014')
train_annotations_filename = os.path.join(root, 'annotations/instances_train2014.json')
val_images_dir = os.path.join(root, 'images/val2014')
val_annotations_filename = os.path.join(root, 'annotations/instances_val2014.json')
log_dir = 'logs'
